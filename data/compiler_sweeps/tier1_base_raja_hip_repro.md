# Tier 1 Base vs RAJA HIP compiler sweep (repro)
...
- The sample `srun -N1 -n4 --` prefix uses 1 node and 4 MPI ranks; change it to match the launcher settings required by your allocation if needed.
