...
if [[ $# -lt 3 ]]; then
  ...
  echo
  echo "For example: "
  echo "    toss4_gcc_caliper.sh 10.3.1 /usr/workspace/wsb/asde/caliper-quartz/share/cmake/caliper /usr/workspace/wsb/asde/caliper-quartz/lib/cmake/adiak [3.27.4]"
  exit 1
fi
