...
void INTSC_HEXHEX_EXP::runSeqVariant(VariantID vid)
{
  ...
  switch ( vid ) {
    ...
    default : {
      getCout() << "\n  INTSC_HEXHEX_EXP : Unknown variant id = " << vid << std::endl;
    }
...
RAJAPERF_DEFAULT_TUNING_DEFINE_BOILERPLATE(INTSC_HEXHEX_EXP, Seq, Base_Seq, Lambda_Seq, RAJA_Seq)
