...
RAJA_HOST_DEVICE
RAJA_INLINE void donor_tet_nodes_fast_exp(Int_type const dtet, Int_type &n0,
...
RAJA_HOST_DEVICE RAJA_INLINE void transform_donor_tet_fixed_runtime_dtet_aosoa(
  ...
  donor_tet_nodes_fast_exp(dtet, n0, n1, n2, n3);
...
{
  hex_intsc_subz(xds, xts, dfacet, ttet, vv_thr, vx_thr, vy_thr, vz_thr);
}
