...
#define MPA_X(dx, dy, dz, e)                                                      \
  X[dx + mpa::D1D * dy + mpa::D1D * mpa::D1D * dz + mpa::D1D * mpa::D1D * mpa::D1D * e]
#define MPA_Y(dx, dy, dz, e)                                                      \
  Y[dx + mpa::D1D * dy + mpa::D1D * mpa::D1D * dz + mpa::D1D * mpa::D1D * mpa::D1D * e]
#define MPA_D(qx, qy, qz, e)                                                      \
  D[qx + mpa::Q1D * qy + mpa::Q1D * mpa::Q1D * qz + mpa::Q1D * mpa::Q1D * mpa::Q1D * e]
