...
#include "apps/INTSC_HEXHEX_NEW.hpp"
#include "apps/INTSC_HEXHEX_EXP.hpp"
...
//
  ...
  std::string("Apps_INTSC_HEXHEX_NEW"),
  std::string("Apps_INTSC_HEXHEX_EXP"),
...
//
    ...
    case Apps_INTSC_HEXHEX_NEW : {
       kernel = new apps::INTSC_HEXHEX_NEW(run_params);
       break;
    }
    case Apps_INTSC_HEXHEX_EXP : {
       kernel = new apps::INTSC_HEXHEX_EXP(run_params);
       break;
    }
